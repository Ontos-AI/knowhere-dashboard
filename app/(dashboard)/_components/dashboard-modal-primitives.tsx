...
export const dashboardDesktopModalContentClassName =
  "w-screen max-w-none gap-0 rounded-none border-border bg-background p-0 shadow-none sm:w-[calc(100vw-2rem)] sm:max-w-[560px] [&>button]:hidden";

export const dashboardDesktopFieldLabelClassName =
  "text-sm font-normal leading-[18px] text-foreground lg:leading-5";

export const dashboardDesktopTextFieldClassName =
  "h-10 w-full rounded-none border border-border bg-card px-3 text-xs leading-4 text-foreground shadow-none outline-none placeholder:text-muted-foreground focus-visible:ring-2 focus-visible:ring-primary/20";

export const dashboardDesktopSecretFieldClassName =
  "min-h-[58px] w-full rounded-none border border-border bg-card px-3 py-2.5 text-xs leading-4 text-foreground lg:min-h-[68px]";
...
export const DashboardDesktopDialogCloseButton = () => {
  return (
    <DialogClose asChild>
      <button
        type="button"
        className="flex size-6 shrink-0 items-center justify-center rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/20"
      >
