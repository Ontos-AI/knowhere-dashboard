...
export const ClawActionButton = ({
  ...
  return (
    <Link
      className={cn(
        "group inline-flex h-[52px] items-center justify-center rounded-full px-7 font-sans text-lg leading-6 tracking-normal transition-[background-color,border-color,border-bottom-width] duration-150 min-[640px]:h-[72px] min-[640px]:px-9 min-[640px]:max-[767px]:h-[52px] min-[640px]:max-[767px]:px-7 min-[640px]:max-[767px]:text-lg min-[640px]:max-[767px]:leading-6 min-[768px]:max-[768px]:h-[52px] min-[768px]:max-[768px]:px-7 min-[768px]:max-[768px]:text-lg min-[768px]:max-[768px]:leading-6 min-[769px]:h-[52px] min-[769px]:px-7 min-[769px]:text-lg min-[769px]:leading-6",
        variant === "primary"
