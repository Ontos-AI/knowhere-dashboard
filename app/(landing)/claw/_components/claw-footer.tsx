...
export const ClawFooter = () => {
  return (
    <footer className="bg-[#fafafa] px-4 py-4 shadow-[inset_0_0_0_1px_#e4e4e7] min-[640px]:max-[767px]:px-12 min-[640px]:max-[767px]:py-[22px] min-[768px]:max-[768px]:px-12 min-[768px]:max-[768px]:py-[22px] min-[769px]:px-12 min-[769px]:py-6">
