...
async function handleRequest(request: Request) {
  ...
  // Try OpenAPI handler first (for REST/OpenAPI clients and documentation like Scalar UI)
  // OpenAPI handler is stricter and only matches valid REST API requests
  ...
  // Fallback to RPC handler (for oRPC TypeScript client)
